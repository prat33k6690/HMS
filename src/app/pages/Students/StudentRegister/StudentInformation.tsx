    ...
    return (
        <div>
            <div className='bg-white  borderForm p-3' >
                <h4 className='fs-5'   >Student Information <svg xmlns="http://www.w3.org/2000/svg" style={{ height: "16px" }} fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
