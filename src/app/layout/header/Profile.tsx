      ...
      <div>
        ...
        >
          <ul style={{ fontSize: "13px" }} className="d-grid table-hover  align-items-center justify-content-center gap-2 mt-3 text-md fw-medium text-black text-muted">
            ...
            <li className="  px-4 py-1 rounded cursor-pointer flex items-center hover-effect">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" style={{marginRight:"10px"}} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-user">
            ...
            <li className="  px-4 py-1 rounded cursor-pointer flex items-center gap-2 hover-effect">
              <IoSettingsOutline size={16} className="fw-bolder me-2" />
              Setting
            </li>
            <li className="  px-4 py-1 rounded cursor-pointer flex items-center gap-2 hover-effect">
              <IoLogOutOutline size={16} className="fw-bolder me-2" />
              Log Out
            </li>
          </ul>
